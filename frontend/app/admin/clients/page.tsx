      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200 h-fit sticky top-8">
          ...
          <form action={editingClient ? updateClient : createClient} className="space-y-4">
            ...
            <button
              type="submit"
              className={`w-full text-white py-2 px-4 rounded-md font-medium transition-colors ${editingClient ? 'bg-orange-600 hover:bg-orange-700' : 'bg-blue-600 hover:bg-blue-700'
                }`}
            >
